...
test('create workspace shows form for user with no workspaces', function () {
    ...
    $response->assertInertia(fn ($page) => $page
        ...
        ->where('availableContentLanguages.0', ['value' => 'vi', 'label' => 'Tiếng Việt', 'englishName' => 'Vietnamese'])
        ->where('availableContentLanguages.1', ['value' => 'en', 'label' => 'English', 'englishName' => 'English'])
    );
});
