...
$workspaceDeleteConditionalMemberMarkers = [
    'en' => 'without another King Social Hub workspace',
    'vi' => 'không có không gian làm việc King Social Hub nào khác',
...
test('workspace delete members warning describes conditional permanent deletion', function () {
    ...
    expect($warning)
        ...
        ->toContain('without another King Social Hub workspace')
