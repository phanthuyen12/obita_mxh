...
use App\Http\Controllers\App\Omnichat\LiveChat\AiBotController as LiveChatAiBotController;
use App\Http\Controllers\App\Omnichat\LiveChat\ChannelAiController as LiveChatChannelAiController;
use App\Http\Controllers\App\Omnichat\LiveChat\ContactController as LiveChatContactController;
use App\Http\Controllers\App\Omnichat\LiveChat\ConversationController as LiveChatConversationController;
use App\Http\Controllers\App\Omnichat\LiveChat\SettingsController as LiveChatSettingsController;
use App\Http\Controllers\App\Omnichat\LiveChat\StatsController as LiveChatStatsController;
...
Route::middleware(['auth', EnsureAccountReady::class, EnsureHasWorkspace::class])->group(function () {
    ...
    Route::middleware(EnsureOmnichatAccess::class)->group(function () {
        ...
        Route::get('omnichat/livechat/analytics', [LiveChatStatsController::class, 'index'])->name('app.omnichat.livechat.analytics');
        Route::get('omnichat/livechat/settings', [LiveChatSettingsController::class, 'show'])->name('app.omnichat.livechat.settings.show');
        Route::put('omnichat/livechat/settings', [LiveChatSettingsController::class, 'update'])->name('app.omnichat.livechat.settings.update');
        Route::get('omnichat/livechat/ai-bots', [LiveChatAiBotController::class, 'index'])->name('app.omnichat.livechat.ai-bots.index');
        ...
        Route::get('omnichat/livechat/contacts/{contact}', [LiveChatContactController::class, 'show'])->name('app.omnichat.livechat.contacts.show');
