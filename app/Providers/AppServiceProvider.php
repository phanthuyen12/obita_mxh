...
use App\Models\ContentWorkflowMember;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->afterResolving(AiManager::class, function (AiManager $manager): void {
            $manager->extend('dify', fn ($app, array $config): DifyTextProvider => new DifyTextProvider(
                config: $config,
                events: $app['events'],
                workflowClient: $app->make(DifyWorkflowClient::class),
            ));
        });
    ...
    protected function configureMorphMap(): void
    {
        Relation::enforceMorphMap([
            ...
            'contentCloneCampaign' => ContentCloneCampaign::class,
            'contentClonePreviewTask' => ContentClonePreviewTask::class,
            'contentWorkflow' => ContentWorkflow::class,
            'contentWorkflowMember' => ContentWorkflowMember::class,
            'folder' => Folder::class,
            'folderPermission' => FolderPermission::class,
            'invite' => Invite::class,
            'media' => Media::class,
            'notification' => Notification::class,
            'notificationPreference' => NotificationPreference::class,
            'omnichatChannel' => OmnichatChannel::class,
            'omnichatContact' => OmnichatContact::class,
            'omnichatContactIdentity' => OmnichatContactIdentity::class,
            'omnichatConversation' => OmnichatConversation::class,
            'omnichatMessage' => OmnichatMessage::class,
            'omnichatTag' => OmnichatTag::class,
            'omnichatWebchatSession' => OmnichatWebchatSession::class,
            'omnichatWebhookEvent' => OmnichatWebhookEvent::class,
            'pageFollowerSnapshot' => PageFollowerSnapshot::class,
            'plan' => Plan::class,
            'post' => Post::class,
            'postComment' => PostComment::class,
            'postMetricSnapshot' => PostMetricSnapshot::class,
            'postPlatform' => PostPlatform::class,
            'socialAccount' => SocialAccount::class,
            'socialAccountGroup' => SocialAccountGroup::class,
