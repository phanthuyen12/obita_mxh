...
class UpdatePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'folder_id' => ['sometimes', 'nullable', 'uuid', Rule::exists('folders', 'id')->where('workspace_id', $this->user()->current_workspace_id)],
            'content' => [
                'nullable',
                'string',
                'max:10000',
            ...
            'is_ceo_content' => ['sometimes', 'boolean'],
            'topic_tags' => ['sometimes', 'nullable', 'array', 'max:20'],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if ($platformsById->filter(fn (Platform $platform): bool => $platform === Platform::WordPress)->count() > 1) {
                $validator->errors()->add('platforms', 'Mỗi bài viết chỉ được chọn một website WordPress.');
            }
