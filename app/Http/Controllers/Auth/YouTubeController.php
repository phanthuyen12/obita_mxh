...
class YouTubeController extends SocialController
{
    ...
    public function callback(Request $request): InertiaResponse|RedirectResponse
    {
        ...
        try {
            ...
            if (count($channels) === 1) {
                ...
                $this->ensureNetworkAvailable($workspace, $this->platform, (string) data_get($channel, 'id'));
    ...
    public function select(Request $request): InertiaResponse
    {
        ...
        try {
            ...
            $this->ensureNetworkAvailable($workspace, $this->platform, (string) data_get($selectedChannel, 'id'));
