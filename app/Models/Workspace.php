...
class Workspace extends Model
{
    ...
    public function members(): BelongsToMany
    {
        return $this->belongsToMany(User::class)
            ->withPivot(['role', 'can_omnichat', 'can_content'])
            ->withTimestamps();
    }
    ...
    public function socialAccountGroups(): HasMany
    {
        return $this->hasMany(SocialAccountGroup::class);
    }
    ...
    public function contentCloneCampaigns(): HasMany
    {
        return $this->hasMany(ContentCloneCampaign::class);
    }
