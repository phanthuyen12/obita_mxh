...
class Post extends Model
{
    ...
    protected $appends = ['topic_tags'];

    protected $fillable = [
        'workspace_id',
        'folder_id',
        'content_workflow_id',
        'content_clone_campaign_id',
        'workflow_status',
        'workflow_note',
        'user_id',
        'content',
    ...
    public function contentCloneCampaign(): BelongsTo
    {
        return $this->belongsTo(ContentCloneCampaign::class);
    }
    ...
    protected function topicTags(): Attribute
    {
        return Attribute::get(function (): array {
            $tags = $this->relationLoaded('tags')
                ? $this->getRelation('tags')
                : $this->tags()->get(['tags.id', 'tags.name']);
