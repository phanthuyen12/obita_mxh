...
enum ContentType: string
{
    ...
    // WordPress
    case WordPressArticle = 'wordpress_article';
    ...
    public function platform(): SocialPlatform
    {
        return match ($this) {
            ...
            self::WordPressArticle => SocialPlatform::WordPress,
        };
    }
    ...
    public static function defaultFor(SocialPlatform $platform): ?self
    {
        return match ($platform) {
            ...
            SocialPlatform::WordPress => self::WordPressArticle,
            default => null,
        };
    }
}
