...
#[Name('King Social Hub')]
#[Version('1.0.0')]
#[Icon('images/king-social-hub/logo.png', mimeType: 'image/png')]
#[Instructions('King Social Hub is a social media scheduling platform. Use this server to manage posts, signatures, labels, social accounts, workspaces, and API keys.')]
