        ...
        <tr>
          <td style="border-radius: 12px; background-color: #ffffff; padding: 40px; font-size: 15px; color: #3f3f46; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.05); border: 1px solid #e4e4e7;">
            <div style="text-align: center; margin-bottom: 24px;">
              <span style="display: inline-block; width: 48px; height: 48px; line-height: 48px; border-radius: 50%; background-color: #fef3c7; color: #d97706; font-size: 22px; font-weight: bold;">⏳</span>
            </div>

            <h1 style="margin: 0 0 16px; font-size: 22px; font-weight: 700; color: #09090b; text-align: center;">
              {{ $title }}
            </h1>
            ...
            <div style="margin-top: 20px; border-radius: 8px; background-color: #f4f4f5; padding: 16px; border: 1px solid #e4e4e7;">
              <p style="margin: 0 0 8px; font-size: 13px; font-weight: 600; color: #71717a; text-transform: uppercase; letter-spacing: 0.5px;">
                Tác giả: <span style="color: #18181b; text-transform: none;">{{ $authorName }}</span>
              </p>
              <p style="margin: 0 0 8px; font-size: 13px; font-weight: 600; color: #71717a; text-transform: uppercase; letter-spacing: 0.5px;">
                Nội dung bài viết:
              </p>
              ...
              <div style="margin-top: 12px; padding-top: 12px; border-top: 1px dashed #d4d4d8; font-size: 13px; color: #d97706; font-weight: 600;">
                🕒 Lịch đăng dự kiến: {{ $scheduledAt }}
              </div>
              @endif
            </div>

            <div style="margin-top: 32px; text-align: center;">
              <a href="{{ $url }}" style="display: inline-block; text-decoration: none; padding: 14px 28px; font-size: 15px; font-weight: 600; line-height: 1; border-radius: 8px; background-color: #d97706; color: #ffffff;">
                Duyệt bài viết ngay &rarr;
              </a>
            </div>
          </td>
        </tr>
