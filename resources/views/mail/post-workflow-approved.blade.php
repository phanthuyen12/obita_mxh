        ...
        <tr>
          <td style="border-radius: 12px; background-color: #ffffff; padding: 40px; font-size: 15px; color: #3f3f46; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.05); border: 1px solid #e4e4e7;">
            <div style="text-align: center; margin-bottom: 24px;">
              <span style="display: inline-block; width: 48px; height: 48px; line-height: 48px; border-radius: 50%; background-color: #dcfce7; color: #15803d; font-size: 24px; font-weight: bold;">✓</span>
            </div>
            ...
            <div style="margin-top: 20px; border-radius: 8px; background-color: #f4f4f5; padding: 16px; border: 1px solid #e4e4e7;">
              ...
              <div style="margin-top: 12px; padding-top: 12px; border-top: 1px dashed #d4d4d8; font-size: 13px; color: #15803d; font-weight: 600;">
                🕒 Lịch đăng: {{ $scheduledAt }}
              </div>
              @endif
            </div>

            <div style="margin-top: 32px; text-align: center;">
              <a href="{{ $url }}" style="display: inline-block; text-decoration: none; padding: 14px 28px; font-size: 15px; font-weight: 600; line-height: 1; border-radius: 8px; background-color: #18181b; color: #ffffff;">
                Xem chi tiết bài viết &rarr;
              </a>
            </div>
          </td>
        </tr>
