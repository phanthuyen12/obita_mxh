...
Clean product mockup photograph of {{ $scene }}, polished commercial product photography lighting, soft long shadow, minimal styling, editorial Apple-style aesthetic.
        @break
    @case('poster')
Professional graphic design marketing poster of {{ $scene }}, modern typographic poster design layout, clean structured composition, high quality marketing graphics.
        @break
@endswitch

@if($has_text)
This is a marketing poster. You MUST write the requested text legibly on the image as part of the graphic design. Ensure the spelling is 100% correct, using high-quality typography.
@else
...
@if($has_logo)
A reference image containing the brand logo is provided with this request. You MUST integrate this logo naturally and elegantly into the image composition (for example: in a corner, on a product, on a sign, or as a tasteful watermark). Maintain the original colors and shape of the logo.
@endif
