const PLATFORM_LOGOS: Record<string, string> = {
    ...
    zalo: '/images/accounts/zalo-oa.svg',
    lazada: '/images/accounts/lazada.png',
    shopee: '/images/accounts/shopee.svg',
    wordpress: '/images/accounts/wordpress.svg',
    'wordpress-site': '/images/accounts/wordpress.svg',
    twitter: '/images/accounts/x.png',
};
...
const PLATFORM_LABELS: Record<string, string> = {
    ...
    'wordpress-site': 'Website WordPress',
};
