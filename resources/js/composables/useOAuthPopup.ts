...
import { connect as lazadaConnect } from '@/routes/app/social/lazada';
...
import { connect as shopeeConnect } from '@/routes/app/social/shopee';
...
import { connect as zaloOaConnect } from '@/routes/app/social/zalo-oa';
...
const CONNECT_ROUTES: Record<string, { url: () => string }> = {
    ...
    [Platform.Lazada]: lazadaConnect,
    [Platform.Shopee]: shopeeConnect,
