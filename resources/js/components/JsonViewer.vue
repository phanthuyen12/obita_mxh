...
<template>
    <div
        class="json-viewer overflow-hidden rounded-lg border-2 border-foreground"
    >
        <div
            class="flex items-center justify-end border-b-2 border-foreground/15 bg-card px-2 py-1.5"
        >
            <button
                type="button"
                class="inline-flex h-7 items-center gap-1.5 rounded-md border-2 border-foreground bg-card px-2 text-xs font-bold tracking-wider uppercase shadow-[1px_1px_0_var(--foreground)] transition hover:-translate-x-px hover:-translate-y-px hover:shadow-[2px_2px_0_var(--foreground)] active:translate-x-0 active:translate-y-0 active:shadow-[0_0_0_var(--foreground)]"
