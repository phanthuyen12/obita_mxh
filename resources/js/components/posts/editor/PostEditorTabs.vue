...
import SelectedChannelsSummary from '@/components/posts/editor/SelectedChannelsSummary.vue';
...
<template>
    <Tabs v-model="activeTab" class="flex h-full flex-col">
        ...
        >
            ...
            <TabsTrigger v-if="!hideSchedule" value="schedule">{{
        ...
        >
            <SelectedChannelsSummary
                ...
                :disabled="isReadOnly"
                @toggle="(id) => emit('toggle-platform', id)"
            />
        </TabsContent>
