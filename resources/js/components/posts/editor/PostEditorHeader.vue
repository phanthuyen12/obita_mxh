...
const isWorkflowApproved = computed(() => props.workflowStatus === 'approved');
</script>
    ...
    >
        ...
        <div class="ml-auto hidden lg:flex">
            <PostEditorActions
                ...
                :hide-schedule="hideSchedule"
                :hide-publishing-actions="hidePublishingActions"
