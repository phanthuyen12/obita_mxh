...
<template>
    <div class="flex-shrink-0">
        ...
        <header
            class="hidden items-center justify-between gap-4 border-b-2 border-foreground/10 bg-card px-4 py-2 lg:flex"
        >
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="flex min-w-0 items-center gap-3">
                    ...
                    <Badge
                        :variant="statusConfig(automation.status).variant"
                        class="shrink-0"
                    >
                        <component
                            :is="statusConfig(automation.status).icon"
                            class="size-3"
                        />
