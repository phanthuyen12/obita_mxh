...
<template>
    ...
    >
        ...
        <!-- Soft gold glow -->
        <div
            class="bg-gold/35 pointer-events-none absolute -top-24 -left-24 size-[440px] rounded-full blur-3xl"
        />
        <div
        ...
        >
            ...
            >
                <div
                    class="bg-gold flex size-16 -rotate-2 items-center justify-center rounded-2xl border-2 border-foreground shadow-sm"
                >
