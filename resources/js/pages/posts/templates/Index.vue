...
const FORMAT_LABEL: Record<string, string> = {
    instagram_carousel: 'Băng chuyền',
    instagram_feed: 'Bảng tin',
    instagram_story: 'Tin',
    linkedin_post: 'Bài đăng',
    linkedin_page_post: 'Bài đăng trang',
    x_post: 'Bài đăng',
    threads_post: 'Bài đăng',
    bluesky_post: 'Bài đăng',
    mastodon_post: 'Bài đăng',
    facebook_post: 'Bài đăng',
    facebook_story: 'Tin',
    pinterest_pin: 'Ghim',
};
