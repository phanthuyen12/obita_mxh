      ...
      <div class="sheet-body-scroll">
        ...
        <div class="profile-hero-section">
          ...
          <div v-if="!editMode" class="hero-name-col">
            ...
            <span class="hero-status">Hoạt động: {{ customer.lastActive }}</span>
          </div>
          ...
          <div class="profile-action-bar">
            <a :href="'tel:' + customer.phone" class="quick-act-btn call-act">
        ...
        <div class="info-card-group">
          <div class="group-title-row">
            <div class="title-with-icon">
              <ion-icon :icon="pricetagOutline" class="title-icon text-amber"></ion-icon>
              <span class="group-title">Tags phân loại khách hàng</span>
            </div>
            <span class="tag-counter">{{ editedCustomer.tags?.length || 0 }} thẻ</span>
          </div>
          ...
          <div class="active-tags-cloud">
            ...
            <span v-if="!editedCustomer.tags?.length" class="empty-tag-hint">
        ...
        <!-- 2. THÔNG TIN GIAO DỊCH & DOANH THU -->
        <div class="info-card-group">
          <div class="title-with-icon">
            <ion-icon :icon="cardOutline" class="title-icon text-emerald"></ion-icon>
          ...
          <div class="meta-data-grid">
            <div class="meta-item">
              ...
              <span class="meta-value highlight-money">{{ customer.totalSpent }}</span>
            </div>
            <div class="meta-item">
        ...
        <!-- 3. GHI CHÚ NHU CẦU & CHĂM SÓC -->
        <div class="info-card-group">
          <div class="title-with-icon">
            <ion-icon :icon="documentTextOutline" class="title-icon text-sky"></ion-icon>
          ...
          <div v-if="!editMode" class="notes-display-box">
            ...
            <p v-else class="notes-empty">Chưa có ghi chú nào cho khách hàng này.</p>
          </div>
