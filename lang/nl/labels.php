...
return [
    ...
    'create' => [
        ...
        'description' => 'Geef je label een naam en kies een kleur',
        'name' => 'Naam',
        'name_placeholder' => 'Voer een labelnaam in...',
        'color' => 'Kleur',
        'submit' => 'Label aanmaken',
        'submitting' => 'Aanmaken...',
    ],
    'edit' => [
        'title' => 'Label bewerken',
        'description' => 'Werk de naam en kleur van dit label bij',
        'name' => 'Naam',
        'name_placeholder' => 'Voer een labelnaam in...',
        'color' => 'Kleur',
