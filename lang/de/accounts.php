...
return [
    ...
    'descriptions' => [
        ...
        'shopee' => 'Connect your Shopee shop and synchronize Seller Chat',
        'wordpress' => 'Verbinden Sie Ihre WordPress-Website über die REST-API, um Beiträge zu veröffentlichen',
    ],
    'disconnect_modal' => [
        'title' => 'Konto trennen',
    ...
    'flash' => [
        ...
        'batch_disconnected' => 'Selected accounts disconnected successfully!',
        'access_updated' => 'Page access updated successfully!',
    ],
    'popup_callback' => [
        ...
        'facebook_setup_pending' => 'Facebook connection received. Please allow about 30 seconds while message delivery is configured.',
    ],
];
