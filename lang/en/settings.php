...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}:count other member will lose access. Members without another King Social Hub workspace are permanently deleted.|[2,*]:count other members will lose access. Members without another King Social Hub workspace are permanently deleted.',
    ...
    'members' => [
        ...
        'errors' => [
            ...
            'email_belongs_to_account' => 'This email already belongs to another King Social Hub account. Ask for a dedicated work email instead.',
        ],
    ...
    'ai' => [
        'default_providers_title' => 'Default AI Providers',
        'default_providers_description' => 'Configure default AI providers for content cloning, text, and image generation.',
        'api_keys_title' => 'Provider API Keys',
        'api_keys_description' => 'Manage API keys for AI providers (OpenAI, OpenRouter, Anthropic, Gemini...).',
        'models_title' => 'Default AI Models',
        'models_description' => 'Customize AI model names per provider (e.g. OpenRouter: openai/gpt-4o-mini, x-ai/grok-imagine-image-2.0...).',
        'configured' => 'Configured',
        'enter_key' => 'Enter API Key',
        'text_model' => 'Text Model',
        'image_model' => 'Image Model',
        'fields' => [
            'content_clone_provider' => 'Content Clone AI Provider',
            'text_provider' => 'Text AI Provider',
            'image_provider' => 'Image AI Provider',
        ],
    ],
