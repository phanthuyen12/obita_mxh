...
return [
    'title' => 'MCP',
    'subtitle' => 'Connect AI assistants to your King Social Hub workspace. They use the same permissions as each signed-in user.',
    'copy_step' => 'Copy your King Social Hub server URL',
    ...
    'disconnect_confirm' => 'This signs the app out of King Social Hub. It will need to reconnect before it can use MCP again.',
    ...
    'authorize' => [
        'page_title' => 'Authorize Application - King Social Hub',
        ...
        'error_page_title' => 'Authorization failed - King Social Hub',
    ...
    'clients' => [
        ...
        'cursor' => 'Add King Social Hub as a remote MCP server in Cursor.',
        'cursor_name' => 'Cursor',
