...
return [
    ...
    */
    ...
    'platforms' => [
        ...
        'shopee' => [
            'enabled' => env('SHOPEE_ENABLED', true),
            'api' => env('SHOPEE_API_BASE_URL', 'https://partner.shopeemobile.com'),
            'auth_api' => env('SHOPEE_AUTH_BASE_URL', 'https://partner.shopeemobile.com'),
        ],

        'lazada' => [
            'enabled' => env('LAZADA_ENABLED', true),
            'authorize_url' => env('LAZADA_AUTHORIZE_URL', 'https://auth.lazada.com'),
            'auth_api' => env('LAZADA_AUTH_API', 'https://auth.lazada.com/rest'),
            'api' => env('LAZADA_API', 'https://api.lazada.vn/rest'),
        ],
        'zalo-oa' => [
            'enabled' => env('ZALO_OA_ENABLED', true),
            'api' => env('ZALO_OA_API', 'https://openapi.zalo.me'),
            'oauth_api' => env('ZALO_OA_OAUTH_API', 'https://oauth.zaloapp.com'),
        ],
        'discord' => [
    ...
    /*
    |--------------------------------------------------------------------------
    | Analytics Cron Schedules
    |--------------------------------------------------------------------------
    |
    | Configuration for automated background sync and growth metrics capture.
    | Admin can override these in .env (e.g. ANALYTICS_SYNC_CRON="0 0 * * *")
    |
    */

    'analytics' => [
        'sync_cron' => env('ANALYTICS_SYNC_CRON', '0 */6 * * *'),
        'metrics_capture_cron' => env('ANALYTICS_METRICS_CAPTURE_CRON', '*/30 * * * *'),
        'followers_capture_cron' => env('ANALYTICS_FOLLOWERS_CAPTURE_CRON', '5 0 * * *'),
    ],
